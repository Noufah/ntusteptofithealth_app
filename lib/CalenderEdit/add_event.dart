...
import 'package:ntutepstofithealths_app/CalenderEdit/event_firestore_service.dart';
...
class AddEventPage extends StatefulWidget {
  ...
  const AddEventPage({Key key, this.note, event}) : super(key: key);
...
class _AddEventPageState extends State<AddEventPage> {
  ...
  void initState() {
    ...
    _detail = TextEditingController(text:  widget.note != null ? widget.note.Detail : "");
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  maxLines: 5,
                  validator: (value) =>
                      (value.isEmpty) ? "Please Enter Detail" : null,
                  style: style,
                  decoration: InputDecoration(
                      labelText: "Detail",
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
